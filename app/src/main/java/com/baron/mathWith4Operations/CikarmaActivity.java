...
public class CikarmaActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int rastgelesayi2 = rastgelesayiOlusturucu2.nextInt(rastgelesayi - 0) + 1;
        ...
        countDownTimer = new CountDownTimer(mTimeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                mTimerRunning = false;
                Intent intent = new Intent(CikarmaActivity.this, CtSonucActivity.class);
        ...
        try {
            ...
            switch (v.getId()) {
                    ...
                    if (sonucc == cevap) {
                        ...
                        CountDownTimer countDownTimer2 = new CountDownTimer(a,1000) {
                            ...
                            public void onTick(long millisUntilFinished) {
                                ...
                                ply[0] = MediaPlayer.create(CikarmaActivity.this,R.raw.ses1);
                                ply[0].start();
                            ...
                            public void onFinish() {
                                ...
                                linearLayout.setBackgroundColor(getResources().getColor(R.color.darkyellow));
                            }
                        }.start();
                        ...
                        CountDownTimer countDownTimer3 = new CountDownTimer(a,1000) {
                            @Override
                            public void onTick(long millisUntilFinished) {
                                ply[0] = MediaPlayer.create(CikarmaActivity.this,R.raw.ses2);
                                ply[0].start();
                ...
                case R.id.btngeritus2:
                    ...
                    Intent d = new Intent(CikarmaActivity.this, DortislemActivity.class);
                    startActivity(d);
